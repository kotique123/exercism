...
int assemble_code() {
    int sum_of_blue = zhang::blue::code_fragment() + khan::blue::code_fragment() +
    garcia::blue::code_fragment();
    int sum_of_red = zhang::red::code_fragment() + khan::red::code_fragment() +
    garcia::red::code_fragment();
    return sum_of_blue * sum_of_red;
}
}